...
Function (EXECUTE_PERL)
  ...
  If (EXECUTE_PERL_FILE)
    ...
    If (EXECUTE_PERL_OUTPUT)
      Set (${EXECUTE_PERL_OUTPUT} ${EXECUTE_PERL_OUTPUT_VARIABLE} CACHE INTERNAL "Output From Perl" FORCE)
    ElseIf (EXECUTE_PERL_OUTPUT_VARIABLE)
      Message (${EXECUTE_PERL_OUTPUT_VARIABLE})
    EndIf (EXECUTE_PERL_OUTPUT)
...
Function (PROCESS_PERL_TEMPLATE)
  PARSE_ARGUMENTS (PROCESS_PERL_TEMPLATE
    "PERL_FILE;TEMPLATE;OUTPUT;ARGS" "" ${ARGN})

  If (NOT PROCESS_PERL_TEMPLATE_PERL_FILE)
    Message (FATAL_ERROR "No Perl file specified")
  EndIf (NOT PROCESS_PERL_TEMPLATE_PERL_FILE)

  If (NOT PROCESS_PERL_TEMPLATE_TEMPLATE)
    Message (FATAL_ERROR "No Template file specified")
  EndIf (NOT PROCESS_PERL_TEMPLATE_TEMPLATE)

  Execute_Perl (
    FILE ${PROCESS_PERL_TEMPLATE_PERL_FILE}
    ARGS 
    -t ${PROCESS_PERL_TEMPLATE_TEMPLATE}
    -x ${CMAKE_VARIABLES_XML_OUT_FILE}
    -o ${PROCESS_PERL_TEMPLATE_OUTPUT}
    ${PROCESS_PERL_TEMPLATE_ARGS}
    )
...
Find_Perl_File(PL_FILE_LIBRARY_NAMES WritePackageLibraryDetails.pl)
Find_Perl_File(PL_FILE_GVIM_INIT ProcessGvimTemplate.pl)
Find_Perl_File(PL_FILE_CASE_CONV CaseConv.pl)
Find_Perl_File(PL_FILE_PERL_EXTENSION_MODULE ProcessPerlExtensionModuleTemplate.pl)
Find_Perl_File(PL_FILE_VCXPROJ_USER_FILE CreateVcxprojUserFile.pl)
Find_Perl_File(PL_FILE_PCH_FILE CreatePchFile.pl)
